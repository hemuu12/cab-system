...
export default function sitemap() {
  ...
  return [
    ...
    { url: `${SITE_URL}/nainital-cab`, lastModified: today, changeFrequency: 'monthly', priority: 0.9 },
    { url: `${SITE_URL}/rishikesh-cab`, lastModified: today, changeFrequency: 'monthly', priority: 0.9 },
    { url: `${SITE_URL}/mussoorie-cab`, lastModified: today, changeFrequency: 'monthly', priority: 0.85 },
    { url: `${SITE_URL}/dehradun-cab`, lastModified: today, changeFrequency: 'monthly', priority: 0.85 },
    { url: `${SITE_URL}/mukteshwar-cab`, lastModified: today, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${SITE_URL}/auli-cab`, lastModified: today, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${SITE_URL}/chopta-valley-cab`, lastModified: today, changeFrequency: 'monthly', priority: 0.8 },
