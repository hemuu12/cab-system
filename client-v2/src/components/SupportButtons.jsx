...
export default function SupportButtons() {
  return <div className="support-buttons">
    ...
    <motion.a initial={{opacity:0,scale:.7}} animate={{opacity:1,scale:1}} whileHover={{scale:1.08,y:-2}} whileTap={{scale:.92}} transition={{type:'spring',stiffness:380,damping:24,delay:.08}} className="support phone" href={`tel:${SUPPORT_PHONE}`} aria-label="Call support"><Phone /></motion.a>
  </div>;
}
