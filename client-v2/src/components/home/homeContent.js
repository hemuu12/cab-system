...
export const FOOTER_COLUMNS = [
  ['Explore', [['Plan a journey', '#book'], ['Our services', '/services'], ['Intercity cab guide', '/intercity-cab-guide'], ['Uttarakhand cabs', '/uttarakhand-cabs'], ['Listed routes', '#routes'], ['Available vehicles', '#fleet']]],
