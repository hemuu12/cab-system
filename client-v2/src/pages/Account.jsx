...
export default function Account() {
  ...
  const setSection = useCallback(nextSection => {
    ...
    setSearchParams(next === 'upcoming' ? {} : { section: next }, { replace: true });
  }, [setSearchParams]);
