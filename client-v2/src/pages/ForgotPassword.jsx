...
export default function ForgotPassword() {
  ...
  return <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-night px-5 py-10 text-ivory">
    ...
    <PremiumCard className="relative w-full max-w-[500px] overflow-hidden p-8 sm:p-10">
      ...
      <div className="auth-recovery-head"><BrandLogo className="auth-logo" /><Link className="inline-flex items-center gap-2 text-xs font-semibold text-mist transition hover:text-champagne" to="/login"><ChevronLeft size={15}/> Back to sign in</Link></div>
