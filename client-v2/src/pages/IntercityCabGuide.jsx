...
export default function IntercityCabGuide() {
  return <article className="seo-guide page-shell">
    <nav className="route-crumbs" aria-label="Breadcrumb">
      <Link to="/">Home</Link><span aria-hidden="true">/</span><span aria-current="page">Intercity cab guide</span>
    </nav>
    ...
    <header className="seo-guide-hero">
      ...
      <div className="seo-guide-actions">
        <Link className="button button-ember" to="/#book">Plan your journey <ArrowRight /></Link>
        <Link className="button button-ghost" to="/uttarakhand-cabs">Explore Uttarakhand cabs</Link>
      </div>
    </header>
    ...
    <section className="seo-guide-cta">
      ...
      <Link className="button button-gold" to="/#book">Check vehicles and fares <ArrowRight /></Link>
    </section>
  </article>;
}
