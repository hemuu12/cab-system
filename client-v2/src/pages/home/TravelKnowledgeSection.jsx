...
export default function TravelKnowledgeSection() {
  return <section className="home-travel-knowledge" aria-labelledby="travel-knowledge-title">
    ...
    <div className="home-knowledge-grid">
      <Link to="/intercity-cab-guide"><Map /><span><small>Complete guide</small><strong>How intercity cab booking works</strong><em>Trip formats, vehicle choice and a booking checklist</em></span><ArrowRight /></Link>
      <Link to="/uttarakhand-cabs"><Mountain /><span><small>Our home ground</small><strong>Uttarakhand cab services</strong><em>Hill stations, city transfers and pilgrimage roadheads</em></span><ArrowRight /></Link>
      <Link to="/intercity-cab-guide#fare-breakdown"><BadgeIndianRupee /><span><small>Know the estimate</small><strong>What your cab fare includes</strong><em>Distance charge, allowance, taxes and road costs</em></span><ArrowRight /></Link>
    </div>
  </section>;
}
